...
type PerfConfig struct {
	...
	NoSwProfiler   bool     `ini:"perf.disable-software-profilers"`
	SwProfilers    []string `ini:"perf.software-profilers"`
	NoCaProfiler   bool     `ini:"perf.disable-cache-profilers"`
	CaProfilers    []string `ini:"perf.cache-profilers"`
}
